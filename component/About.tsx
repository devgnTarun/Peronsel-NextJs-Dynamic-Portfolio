...
const About = () => {
    return (
        <div className="w-full flex-col items-center justify-center md:mt-0 mt-[50px] relative">
            <h1 className="heading">About me</h1>
            <div>
                <p className="text-sm text-gray-300 text-center leading-[25px] my-8 w-[90%] mx-auto">Hi, Tarun Devgan this side. Experienced Freelancer developer,  delivering Dynamic Sites, Telegram/Discord/Whatsapp Automated Bots, Bulk emails and many more projects. I have well and good experience in technologies and always learning more technologies to improve and stand well at industry level. </p>
            </div>
