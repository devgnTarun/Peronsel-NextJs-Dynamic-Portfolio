...
const Projects = () => {
    return (
        <div className="w-full flex-col items-center justify-center md:mt-[20px] mt-[60px] relative ">
            ...
            <div className="w-[90%] mx-auto  box_condition  items-center  ">
                ...
                <div className="md:w-[50%] w-[100%] flex-col items-center md:justify-start justify-center relative md:text-start text-center">
                    ...
                    <Link href='' className='mt-3 text-gray-900 xs:text-md text-sm my-4 font-semibold px-8 py-2 rounded-3xl bg-indigo-300 border-b-4 border-indigo-500 hover:border-b-0  '> Check services</Link>
